...
const CartPage = () => {
  ...
  name,id,price,description,imagePath,category,stockLevel
}`);
                  ...
                  <div className="mt-6" key={product.id}>
                    <Link href={`/shop/${product.id}`}>
                      <Image
                        ...
                        className="w-[230px] h-[180px]  hover:scale-110 duration-300  object-contain"
                      />
                    </Link>
