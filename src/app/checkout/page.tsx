  ...
  return (
    <div className="w-full md:max-w-[1440px] mx-auto overflow-hidden lg:pl-0">
      ...
      <div className="w-full flex flex-col justify-center items-center   py-10 lg:pt-32">
        <div className="flex flex-wrap   justify-center items-center p-10 gap-10 py-10 w-full    ">
          ...
          <div className="max-w-[635px] flex flex-col    w-full flex-1 justify-center items-start gap-3   ">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="flex justify-center gap-4   py-2">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="abc"
                    className="p-3  w-full md:w-[530px] border-2 border-black/30 rounded-lg"
              ...
              <button  disabled className="px-7 w-full py-2 mt-2 bg-red-400 text-white rounded-xl">Your Card is Empty </button>  
            }
