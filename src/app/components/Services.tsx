...
const Services = () => {
  return (
    <div className="max-w-[943px] mx-auto my-10">
      <div className="flex flex-wrap gap-[88px] ">
        <div className="w-[249px]   h-[161px]  mx-auto flex justify-center flex-col gap-[24px]">
          <svg
            width="81"
            height="80"
            viewBox="0 0 81 80"
          ...
          >
            ...
            <g clip-path="url(#clip0_51994_331)">
              <path
          ...
          <div className="pl-5">
            <h3 className=" font-semibold leading-[28px]">FREE AND FAST DELIVERY</h3>
        ...
        <div className="w-[249px]  h-[161px]  mx-auto flex justify-center flex-col gap-[24px]">
          <div>
            ...
            >
              ...
              <g clip-path="url(#clip0_51994_348)">
                <path
