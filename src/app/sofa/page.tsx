  ...
  name,price,id,description,imagePath,category,stockLevel,discountPercentage
        ...
        if (searchQuery) {
          filteredData = uniqueData.filter(
            (product: Iproducts) => {
              const productCategroyVise= product.category=="Sofa";
    ...
    <div className="w-full md:max-w-[1440px] mx-auto overflow-hidden lg:pl-0">
      ...
      <div className="flex justify-center items-center h-[306px] flex-col z-50">
        <Image
          ...
          alt="logo image"
        />
        <h2 className="text-[48px] font-medium">Sofa</h2>
      ...
      <div className="max-w-[540px]  mx-auto p-4 -mt-6  ">
        <input
          type="text"
          placeholder="Search by name of product related ctegory (e.g.Cozy Sofa)"
          value={searchQuery}
